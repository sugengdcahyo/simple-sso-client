...
app.config['KEYCLOAK_CLIENT_ID'] = 'app-b'
app.config['KEYCLOAK_CLIENT_SECRET'] = '1yM5rpMsqBJ3eLfJ6uhq1j0e9qr0ujiB'
app.config['KEYCLOAK_REDIRECT_URI'] = 'http://localhost:1235/callback'
...
def index():
    ...
    return '(App B) You are not logged in! <a href="/login">Login</a>'
